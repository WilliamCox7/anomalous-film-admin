        ...
        <div className="form">
          ...
          {this.props.film.type === 'tv-episode' ? (
            <div className="form-section flex">
              ...
              <select id="select-2" className="gold" value={this.props.submissionType}
                onChange={this.props.updateSubType} name="submissionType">
          ...
          {this.props.film.type === 'movie' ? (
            <div className="form-section flex">
              ...
              <select id="select-2" className="gold" value={this.props.submissionType}
                onChange={this.props.updateSubType} name="submissionType">
                <option value="review">film review</option>
                <option value="list">watch list</option>
              </select>
            </div>
          ) : null}
        </div>
